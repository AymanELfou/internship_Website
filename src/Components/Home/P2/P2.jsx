        ...
        <div class="about-section">
            <div class="row g-0">
                <div class="col-md-6 about-text">
                    ...
                    <p class="mb-4 m-3">Have you been waiting for an organisation like Green Warehouse? We understand the importance of reliability, stock and lead times. We understand the needs of installers and technology specialists. We speak the same language.</p>
